...
inline Color Color_Coral{255u, 127u, 127u};
inline Color Color_Salmon{250u, 128u, 114u};
inline Color Color_Mint{127u, 191u, 164u};
inline Color Color_Sage{143u, 188u, 143u};
inline Color Color_Sky{127u, 179u, 216u};
inline Color Color_Periwinkle{139u, 157u, 195u};
inline Color Color_Honey{240u, 208u, 128u};
inline Color Color_Buttercup{245u, 215u, 110u};
inline Color Color_Peach{255u, 173u, 133u};
inline Color Color_Apricot{244u, 164u, 96u};
inline Color Color_Lavender{179u, 157u, 219u};
inline Color Color_Mauve{196u, 167u, 215u};
inline Color Color_Teal{126u, 200u, 200u};
inline Color Color_Seafoam{128u, 203u, 196u};
inline Color Color_Rose{232u, 144u, 156u};
inline Color Color_Blush{240u, 160u, 168u};
inline Color Color_WarmWhite{245u, 240u, 235u};
inline Color Color_Pearl{234u, 234u, 234u};
...
template <> struct TKit::YamlCodec<Onyx::Color>
{
    static void Encode(YamlNode &node, const Onyx::Color &color)
    {
        node << ("#" + color.ToHexadecimal<std::string>(color.a() != 255));
    }

    static YamlReadResult Decode(const ConstYamlNode &node, Onyx::Color &color)
    {
        if (node.IsScalar())
        {
            const std::string str = node.Read<std::string>();
            if (str[0] == '#')
            {
        ...
        if (node.IsSequence())
        {
            const u32 ccount = node.GetChildCount();
            if (ccount != 3 && ccount != 4)
                return YamlReadResult::Error(
                    node.GetId(),
                    TKit::TierString::Format(
                        "Cannot deserialize color. The node must have a child count of 3 or 4, but has {}", ccount));

            if (ccount == 3)
                color = Onyx::Color{node[0].Read<f32>(), node[1].Read<f32>(), node[2].Read<f32>()};
            else if (ccount == 4)
                color = Onyx::Color{node[0].Read<f32>(), node[1].Read<f32>(), node[2].Read<f32>(), node[3].Read<f32>()};
            return YamlReadResult::Ok();
        }
        return YamlReadResult::Error(node.GetId(), "To deserialize a color, node must be either a scalar or sequence");
    }
};
#endif
