...
template <Dimension D> class PointLight
{
  public:
    ...
    PointLight(const f32v<D> &pos = f32v<D>{0.f}, const f32 radius = 1.f, const f32 intensity = 0.8f,
...
class DirectionalLight
{
  public:
    ...
    DirectionalLight(const f32v3 &dir = f32v3{1.f}, const f32 intensity = 0.8f, const Color &color = Color::White)
