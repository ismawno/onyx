...
void windowResizeCallback(GLFWwindow *handle, const i32 width, const i32 height)
{
    Event event{};
    Window *window = windowFromGLFW(handle);
...
static void framebufferResizeCallback(GLFWwindow *handle, const i32 width, const i32 height)
{
    Event event{};
    Window *window = windowFromGLFW(handle);
