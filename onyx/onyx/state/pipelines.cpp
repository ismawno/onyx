...
ONYX_NO_DISCARD static Result<> createShaders()
{
    ...
    auto cmpres = compiler.AddBooleanArgument(ShaderArgument_MatrixLayoutColumn)
    ...
    if (Core::CanNameObjects())
    {
        ...
        TKIT_RETURN_IF_FAILED(s_FillShaders2->CircleVertexShader.SetName("onyx-2D-vertex-shader-circle-stencil"));
        TKIT_RETURN_IF_FAILED(s_FillShaders2->CircleFragmentShader.SetName("onyx-2D-fragment-shader-circle-stencil"));

        TKIT_RETURN_IF_FAILED(s_FillShaders3->CircleVertexShader.SetName("onyx-3D-vertex-shader-circle-stencil"));
        TKIT_RETURN_IF_FAILED(s_FillShaders3->CircleFragmentShader.SetName("onyx-3D-fragment-shader-circle-stencil"));
        ...
        TKIT_RETURN_IF_FAILED(s_FillShaders2->StaticVertexShader.SetName("onyx-2D-vertex-shader-static-stencil"));
        TKIT_RETURN_IF_FAILED(s_FillShaders2->StaticFragmentShader.SetName("onyx-2D-fragment-shader-static-stencil"));

        TKIT_RETURN_IF_FAILED(s_FillShaders3->StaticVertexShader.SetName("onyx-3D-vertex-shader-static-stencil"));
        TKIT_RETURN_IF_FAILED(s_FillShaders3->StaticFragmentShader.SetName("onyx-3D-fragment-shader-static-stencil"));
        ...
        TKIT_RETURN_IF_FAILED(
            s_FillShaders2->ParametricVertexShader.SetName("onyx-2D-vertex-shader-parametric-stencil"));
        TKIT_RETURN_IF_FAILED(
            s_FillShaders2->ParametricFragmentShader.SetName("onyx-2D-fragment-shader-parametric-stencil"));

        TKIT_RETURN_IF_FAILED(
            s_FillShaders3->ParametricVertexShader.SetName("onyx-3D-vertex-shader-parametric-stencil"));
        TKIT_RETURN_IF_FAILED(
            s_FillShaders3->ParametricFragmentShader.SetName("onyx-3D-fragment-shader-parametric-stencil"));
    }
                                                            ...
                                                            const VkPipelineRenderingCreateInfoKHR &renderInfo)
{
    ...
    if constexpr (D == D2)
    {
        ...
        builder.AddAttributeDescription(0, VK_FORMAT_R32_UINT, offsetof(ParaVertex<D2>, Tag));
    }
    else
    {
